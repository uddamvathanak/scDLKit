...
Target after this milestone: cautious continuation of the experimental foundation-model path
...
- keep scGPT annotation tuning experimental and annotation-only
